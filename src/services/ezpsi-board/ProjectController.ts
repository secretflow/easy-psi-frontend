...
export async function agreeJob(
  ...
  return request<API.SecretPadResponse_Void_>('/api/v1alpha1/project/job/agree', {
    method: 'POST',
    headers: {
...
export async function continueJob(
  ...
  return request<API.SecretPadResponse_Void_>('/api/v1alpha1/project/job/continue', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteJob(
  ...
  return request<API.SecretPadResponse_Void_>('/api/v1alpha1/project/job/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function pauseJob(
  ...
  return request<API.SecretPadResponse_Void_>('/api/v1alpha1/project/job/pause', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function rejectJob(
  ...
  return request<API.SecretPadResponse_Void_>('/api/v1alpha1/project/job/reject', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function stopKusciaJob(
  ...
  return request<API.SecretPadResponse_Void_>('/api/v1alpha1/project/job/stop/kuscia', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
